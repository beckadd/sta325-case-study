...
map(data$lm.fit.no_interactions.summary, ~tidy(.))
```
...
map(data$lm.fit.two_way.summary, ~tidy(.))
```
...
map(data$nl.fit.two_degree.summary, ~tidy(.))
```
